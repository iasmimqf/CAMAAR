  ...
  describe "authorization" do
    ...
    context "when user is admin" do
      ...
      describe "PATCH #update" do
        let!(:template) { 
          create(:template, titulo: "Título Original", criador: admin_user) do |t|
            t.questoes.create!(enunciado: "Questão existente", tipo: "Texto")
          end
        }
        ...
        context "with valid parameters" do
          let(:valid_attributes) { 
            { 
              ...
              questoes_attributes: {
                "0" => { id: template.questoes.first.id, enunciado: "Questão existente", tipo: "Texto" }
              }
            } 
          }
