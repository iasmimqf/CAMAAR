...
class RespostaQuestao < ApplicationRecord
  ...
  #    atualizar uma `RespostaQuestao`, garantindo que a resposta esteja sempre
  #    associada a um formulário respondido.
  # Argumentos: Nenhum.
  # Retorno: `true` se a validação passar, `false` caso contrário.
  ...
  #    - **Escala**: Valida se `valor_resposta` é um array com um único inteiro e se
  #      este inteiro está dentro do range de índices de opções da questão.
  ...
  #    Gera logs de depuração (`Rails.logger.debug`).
