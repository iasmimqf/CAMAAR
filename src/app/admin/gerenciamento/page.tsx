...
export default function GerenciamentoPage() {
  ...
  const handleManagementAction = (action: string) => {
    ...
    if (action === "importar-dados") {
      setImportDataModalOpen(true) // abrir o modal
    }
    // adicionar lógica para cada ação de gerenciamento
  }

  const handleImportClasses = () => {
    console.log("Import Classes clicked")
    setImportDataModalOpen(false)
    // adicionar logica para importar turmas
  }
          ...
          <div className="flex items-center justify-center min-h-[calc(100vh-200px)]">
            <div className="bg-white rounded-lg shadow-sm p-12 w-full max-w-md">
              <div className="space-y-4">
                <Button
                  onClick={() => handleManagementAction("importar-dados")}
                ...
                <Button
                  onClick={() => router.push('/admin/gerenciamento-templates')}
                  className="w-full bg-green-500 hover:bg-green-800 text-white font-medium py-3 px-6 rounded-md transition-colors duration-200"
                >
                  Editar Templates
                </Button>
                ...
                <Button
                  onClick={() => router.push('/admin/enviar-formulario')}
                  className="w-full bg-green-500 hover:bg-green-800 text-white font-medium py-3 px-6 rounded-md transition-colors duration-200"
                >
                  Enviar Formulários
                </Button>
                ...
                <Button
                  onClick={() => router.push('/admin/resultado')}
                  className="w-full bg-green-500 hover:bg-green-800 text-white font-medium py-3 px-6 rounded-md transition-colors duration-200"
                >
                  Resultados
                </Button>
